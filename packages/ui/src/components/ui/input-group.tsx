...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: click-to-focus is a mouse convenience, keyboard users already have tab
		<div
			role="group"
